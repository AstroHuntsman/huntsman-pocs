...
serial_into_USBhub_port = interactive(serial_to_usb_widget, serial_into_USBhub_port=serial_into_USBhub);
camera_into_serial = data['camera_into_serial_port']
camera_into_serial_port = interactive(camera_to_serial_widget, camera_into_serial_port=camera_into_serial);
...
camera_into_USBhub_port = interactive(camera_to_usb_widget, camera_into_USBhub_port=camera_into_USBhub);
