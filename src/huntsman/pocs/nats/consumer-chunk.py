...
def create_fits_header(msg, consumer_id):
    """
    Create a properly formatted FITS header from NATS message headers.
        ...
        try:
            ...
            for msg in memory_msgs:
                ...
                if len(msg.data) > 0:
                    ...
                    # Use the new function to create the header
                    header = create_fits_header(msg, consumer_id)
                    ...
                    filename = f"frame_memory_{consumer_id}_{frame_number}{chunk_info}_{timestamp_str}.fits"
        ...
        try:
            ...
            for msg in disk_msgs:
                ...
                if len(msg.data) > 0:
                    ...
                    timestamp_str = datetime.now().strftime('%Y%m%d_%H%M%S_%f')
                    filename = f"frame_disk_{consumer_id}_{frame_number}{chunk_info}_{timestamp_str}.fits"
